package aula05Ex.src.br.com.fecaf.exMediaEscolar;
...
public class MediaEscolarEx {
    public static void main(String[] args) {
        String nomeAluno, nomeProfessor, nomeCurso, nomeDisciplina, sexoAluno, sexoProf, situacao, sexoAluno2 = null,
                sexoProf2 = null;
        ...
        try (Scanner entradaDados = new Scanner(System.in)) {
            ...
            if (media >= 70) {
                situacao = "APROVADO";
                System.out
                        .println(sexoAluno + " " + nomeAluno + " foi " + situacao + " na disciplina " + nomeDisciplina);
                System.out.println("Curso: " + nomeCurso);
                System.out.println("Professor: " + nomeProfessor);
                System.out.printf("Notas " + sexoAluno2 + ":" + numerosFormat.format(nota1) + " " + nota2 + " " + nota3
                        + " " + nota4 + "\n");
                ...
                if ((media + notaExame) / 2 >= 60 && alunoMasc == true) {
                    ...
                    System.out
                            .println(sexoAluno + ":" + nomeAluno + " foi APROVADO na disciplina de " + nomeDisciplina);
                    System.out.println("Curso: " + nomeCurso);
                    System.out.println("Professor(a): " + nomeProfessor);
                    System.out.println("Notas do aluno: " + "Nota 1: " + nota1 + "Nota 2: " + nota2 + "Nota 2: " + nota3
 ...
 * System.out.println("A aluna " + nomeAluno + " foi APROVADA na disciplina " +
 * nomeDisciplina );
 * System.out.println("Curso: " + nomeCurso);
 * System.out.println("Professor: " + nomeProfessor);
 * System.out.printf("Notas do aluno: " + numerosFormat.format(nota1) +
 * numerosFormat.format(nota2) + numerosFormat.format(nota3) +
 * numerosFormat.format(nota4) + "\n" );
 * System.out.println("Média Final: " + media);
 * 
 * } else if (media >= 70 && alunoMasc == true) {
 * System.out.println("O aluno " + nomeAluno + " foi APROVADO na disciplina de "
 * + nomeDisciplina );
 * System.out.println("Curso: " + nomeCurso);
 * System.out.println("Professor: " + nomeProfessor);
 * System.out.println("Notas do aluno: " + nota1 + "" + nota2 + "" + nota3 + ""
 * + nota4);
 * System.out.println("Média Final: " + media);
 * }else if (media < 50) {
 * System.out.println("REPROVADO");
 ...
 * System.out.println("Curso: " + nomeCurso);
 * System.out.println("Professor(a): " + nomeProfessor);
 * System.out.println("Notas do aluno: " + "Nota 1: " + nota1 + "Nota 2: " +
 * nota2 + "Nota 2: " + nota3 + "Nota 4: " + nota4 + "Nota notaExame: " +
 * notaExame);
 * System.out.println("Média Final: " + media);
 * System.out.println("Média final do Exame: " + (media + notaExame / 2));
 * }else if ((media + notaExame) / 2 >= 60 && alunoFemin == true) {
 * System.out.println("Se livrou do exame");
 * System.out.println("A aluna " + nomeAluno + " foi APROVADA na disciplina de "
 * + nomeDisciplina );
 * System.out.println("Curso: " + nomeCurso);
 * System.out.println("Professor(a): " + nomeProfessor);
 * System.out.println("Notas da aluna: " + "\nNota 1: " + nota1 + "\nNota 2: " +
